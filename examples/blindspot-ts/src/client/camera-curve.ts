...
// Curve control points — camera weaves ±2 on X between panels
const curvePoints: THREE.Vector3[] = [
  new THREE.Vector3(0, 0, 5),       // before Panel 0 (approach)
  new THREE.Vector3(0, 0, 0),       // Panel 0: Search
  new THREE.Vector3(2, 0, -20),     // Panel 1: Identity (right weave)
  new THREE.Vector3(-2, 0, -40),    // Panel 2: Onchain (left weave)
  new THREE.Vector3(2, 0, -60),     // Panel 3: Off-chain (right weave)
  new THREE.Vector3(0, 0, -80),     // Panel 4: Verdict (center)
  new THREE.Vector3(0, 0, -85),     // past Panel 4 (exit)
]
